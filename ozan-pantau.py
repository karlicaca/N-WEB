...
#!/usr/bin/python2
# Author : OZAN-UNYIL 
# Team : GRETONGERS & INET SOLIDARITAS

try:
  import os
  import sys
  import time
  import requests as ozan
  import json 
  import urllib2 
...
Created By : \033[1;96mUNYIL-OZAN |\033[1;0m [NEW V-2022]

\033[1;32m------------------------------------------   
\33[93m AUTHOR  : BY CREATED OZAN
\33[93m TELEGRAM : https://t.me/gretongersteamgroup
\33[93m GROUP TEAMS   : https://t.me/inet_solid
\033[1;32m------------------------------------------   
"""
os.system('clear')
print(logo)
